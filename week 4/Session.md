...
#### Your task: Replace the above if-else statement with a single line using the conditional operator
...
#### Can you guys write the pseudocode for the above code!

## 5. Errors

#### What is Syntactic Errors?
...
#### Find the Syntactic and Semantic errors in the code above. Mention the line number too.
